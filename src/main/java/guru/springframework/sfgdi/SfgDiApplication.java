...
public class SfgDiApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("--------- Scope types");
		...
		SpringBootDatasource springBootDatasource = ctx.getBean(SpringBootDatasource.class);
		System.out.println(springBootDatasource.getUserName());
		System.out.println(springBootDatasource.getPassword());
		System.out.println(springBootDatasource.getJdbcURL());
